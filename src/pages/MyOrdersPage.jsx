...
const MyOrdersPage = () => {
      ...
      const mockOrders = [
        {
          ...
          orderItems: [
            {
              name: "Product 1",
              image: "https://picsum.photos/500/300?random=501",
            },
          ],
          totalPrice: 100,
          isPaid: true,
        },
        {
          ...
          orderItems: [
            {
              name: "Product 2",
              image: "https://picsum.photos/500/300?random=502",
            },
          ],
          totalPrice: 150,
          isPaid: false,
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6">
      ...
      <div className="relative shadow-md md:rounded-lg overflow-x-auto">
        <table className="w-full min-w-max text-left text-gray-500">
            ...
            {orders.length > 0 ? (
              orders.map((order) => (
                ...
                >
                  ...
                  <td className="py-2 px-2 sm:py-4 sm:px-4 text-sm sm:text-base">
